...
function validateArchitecture() {
  ...
  if (arch.schema_version !== 1)
    problems.push('Architecture files must set "schema_version": 1.');
  if (arch.diagram_type !== "architecture")
    problems.push(
      'Architecture files must set "diagram_type": "architecture".',
    );
  if (!arch.meta?.title)
    problems.push("Architecture files must include meta.title.");

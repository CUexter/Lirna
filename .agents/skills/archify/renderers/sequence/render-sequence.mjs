...
function validateSequence() {
  ...
  if (sequence.schema_version !== 1)
    problems.push('Sequence files must set "schema_version": 1.');
  if (sequence.diagram_type !== "sequence")
    problems.push('Sequence files must set "diagram_type": "sequence".');
  if (!sequence.meta?.title)
    problems.push("Sequence files must include meta.title.");
  if (
    !Array.isArray(sequence.participants) ||

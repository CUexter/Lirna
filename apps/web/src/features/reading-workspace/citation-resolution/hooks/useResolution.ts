...
import { useAnchoredTargetNavigation } from "../../annotations/hooks/useNavigation";
...
import type { WorkspaceSceneTransitionRequest } from "../../navigation/sceneTransitions";
import type { ReadingView } from "../../types";
import { sameCitationResolutionTarget } from "../consequences";
import type {
  CitationResolutionTarget,
  CitationResolutionWork,
} from "./useModule";
import { useWorkspaceCitationResolutionPanel } from "./usePanel";

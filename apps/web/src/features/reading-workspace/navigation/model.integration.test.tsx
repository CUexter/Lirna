...
import { readingFixture, sourceId, stateId } from "../test-support/fixtures";
import type { ReadingNavigationObservation } from "./observations";
...
const { useReadingSceneNavigationObservations } = await import(
  "./hooks/useSceneObservations"
);
const { useReadingNavigationScope } = await import("./hooks/useNavigation");
const { historyPositionKey } = await import("../position/history");
const { useReadingResume } = await import("../position/hooks/useResume");

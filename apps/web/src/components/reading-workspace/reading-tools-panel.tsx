...
import type {
  ...
  ReadingToolTab,
} from "./reading-tools-panel.types";
import { useReadingToolsLocation } from "./reading-tools-positions";
import { ContentsTab, NotesTab, SupplementaryTab } from "./reading-tools-tabs";

export type { ReadingToolTab } from "./reading-tools-panel.types";
